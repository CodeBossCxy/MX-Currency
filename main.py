...
MX_ERP_API_BASE = "https://vin-teq.on.plex.com/api/datasources/"
...
MX_headers = {
  'Authorization': 'Basic VmluVEVRTWV4aWNvV1NAcGxleC5jb206OWYzM2UxMi00YjExLTQ=',
  'Content-Type': 'application/json'
}
...
if start_time.weekday() == 4:
    ...
    end_time = start_time + timedelta(days=2) - timedelta(hours=7)
else:
    start_time = start_time +timedelta(days=1)
    end_time = start_time
